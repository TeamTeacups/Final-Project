...
PFont bigfont, mediumfont, smallfont, boxfont, boxfont2, okfont, font, font2, font3, loserfont;
...
float w1, w2, h1, h2, w1a, w2a, h1a, h2a, w1b, w2b, h1b, h2b, louis;
...
void setup() {
  ...
  boxfont2 = createFont("Bookman Old Style", 20, true);
  ...
  loserfont = createFont("Bookman Old Style", 100, true);
  ...
  chipey = loadImage("prettychipNONONO.png");
...
void draw() {
  ...
  if (niall==3) {
    ...
    image(mom, 325, 515, width*scaleFactor43, height*scaleFactor5);
    image(duster, 30, 630, width*scaleFactor31, height*scaleFactor31);
    ...
    text("Obstacles Include:", 250, 500);
    textFont(mediumfont);
    text("Cogsworth:", 175, 175);
    text("Lumière:", 325, 275);
    text("Green Plates", 250, 375);
    text("Mrs.Potts:", 175, 575);
    text("Babette:", 325, 685);
    textFont(smallfont);
    ...
    text("Land on a green plate!", 250, 400);
    text("and chip will bounce faster!", 250, 425);
    text("She wants Chip to take a bath", 175, 600);
    text("So she will make Chip lose!", 175, 625);
    text("She will dust Chip away!", 325, 710);
    text("And Chip will fall to the sink!", 325, 735);
  ...
  if (niall==1) {
    ...
    textFont(font3);
    fill(0);
    text("HOW TO PLAY", 250, 440);

    // draw buttons, and text in buttons

    image(chipey, 140, 520, width *scaleFactor3, height *scaleFactor4);
